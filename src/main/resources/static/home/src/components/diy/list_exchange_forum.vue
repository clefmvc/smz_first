<template>
	<div class="diy_home diy_list diy_exchange_forum" id="diy_exchange_forum_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
					<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/exchange_forum/details?exchange_forum_id=' + o['exchange_forum_id']">
										<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/exchange_forum/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/exchange_forum/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table">
			<table class="diy_table">
				<tr class="diy_row">
											<th class="diy_title" v-if="$check_field('get','forum_title','/exchange_forum/list')">
					论坛标题
				</th>
										<th class="diy_title" v-if="$check_field('get','type_of_communication','/exchange_forum/list')">
					交流类型
				</th>
										<th class="diy_title" v-if="$check_field('get','release_date','/exchange_forum/list')">
					发布日期
				</th>
										<th class="diy_title" v-if="$check_field('get','cover_image','/exchange_forum/list')">
					封面图片
				</th>
								</tr>
								<tr class="diy_row" v-for="(o,i) in list" :key="o+i" @click="to_detail(o)">
																<td class="diy_field diy_text" v-if="$check_field('get','forum_title','/exchange_forum/list')">
						<span>
							{{ o["forum_title"] }}
						</span>
					</td>
											<td class="diy_field diy_text" v-if="$check_field('get','type_of_communication','/exchange_forum/list')">
						<span>
							{{ o["type_of_communication"] }}
						</span>
					</td>
											<td class="diy_field diy_date" v-if="$check_field('get','release_date','/exchange_forum/list')">
						<span>
							{{ $toTime(o["release_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
											<td class="diy_field" v-if="$check_field('get','cover_image','/exchange_forum/list')">
						<img class="diy_img" :src="$fullUrl(o['cover_image'])" />
					</td>
								</tr>
			</table>
		</div>
		<!-- 轮播 -->
		 ...
		 <div class="carousel ins_s">
                <div class="slider" ref="slider">
                    ...
                    <router-link :to="'/exchange_forum/details?exchange_forum_id=' + o['exchange_forum_id']" class="lis_cont">
						                        <div class="diy_list_img_box" v-if="imgList.length" >
    					        <div class="diy_row" v-for="(item, index) in imgList" :key="item + index" v-show="$check_field('get',item.name,'/exchange_forum/details') && +item.is_img_list">
    						<div class="diy_title diy_list_img_title">
...
<script>
	export default {
		...
		methods: {
			...
			to_detail(v){
				this.$router.push("/exchange_forum/details?exchange_forum_id="+v.exchange_forum_id)
			},
