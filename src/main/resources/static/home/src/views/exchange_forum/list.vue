					...
					<div class="col">
						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																																														...
																																														<b-form-input size="sm" class="mr-sm-2" placeholder="交流类型搜索" v-model="query['type_of_communication']" />
				...
				<div class="diy_list_select_box">
					<span class="diy_list_select_title">下拉搜索：</span>
						...
						<div class="col">
							<!-- 筛选 -->
							<div class="view sift">
																			<b-dropdown text="交流类型" variant="outline-dark" left>
									<b-dropdown-item @click="filter_set('全部','type_of_communication')">全部</b-dropdown-item>
										<b-dropdown-item v-for="(o,i) in list_type_of_communication" @click="filter_set(o,'type_of_communication')" >
										{{ o }}
										</b-dropdown-item>
								</b-dropdown>
														<!-- 排序 -->
	...
	export default {
      ...
      get_list_before(param) {
			...
			reset() {
										...
										this.query.type_of_communication = ""
										this.search();
			},
