				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 报修记录 -->
							<div><span>报修记录</span></div>
							<table_repair_record v-if="$check_action('/repair_record/table','get')"></table_repair_record>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_repair_record from "../../components/diy/table_repair_record.vue";
	export default {
		data() {
			return {
			};
