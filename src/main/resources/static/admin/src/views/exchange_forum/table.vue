<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/exchange_forum/table','set') || $check_action('/exchange_forum/view','set') || $check_action('/exchange_forum/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/exchange_forum/table','set') || $check_action('/exchange_forum/view','set') || $check_action('/exchange_forum/view','get')"
						...
						<router-link v-if="$check_comment('/exchange_forum/table')" class="e-button el-button--small is-plain el-button--primary"
