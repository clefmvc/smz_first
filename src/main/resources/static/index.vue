		        ...
		        <div class="row">
		            <div class="col-12">
						...
						<div class="Left_box">
							...
							<!-- 推荐交流论坛模块(开始) -->
		<div class="ins warp model1" v-if="$check_action('/exchange_forum/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
							...
							<div class="text_t"><span></span></div>
		                    <div class="more_box">
		                        <router-link to="/exchange_forum/list" class="ins_more more">
		                ...
		                <!-- 交流论坛推荐列表组件 -->
						<div class="list_exchange_forum_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_exchange_forum :list="list_exchange_forum" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toToggle(){
				this.isAdmin = !this.isAdmin;
								...
								// 获取交流论坛列表
			get_exchange_forum() {
				let url = "~/api/exchange_forum/get_list?";
														let param = {
									"page": 1,
					"size": 12
				}
					...
					if (json.result) {
						this.list_exchange_forum = json.result.list;
					}
				})
			},
		...
		computed: {
							    list_table_exchange_forum() {
		        var list = this.list_exchange_forum;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_exchange_forum.map((o) => {
		                // 第二个中括号是对象的属性
