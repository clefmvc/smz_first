<template>
	<div class="diy_details page_exchange_forum" id="exchange_forum_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_exchange_forum'>
							<div_exchange_forum :obj="obj"></div_exchange_forum>
...
<script>
	import div_exchange_forum from "@/components/diy/div_exchange_forum.vue";
		...
		methods:{
			async get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.exchange_forum_id;
													}
			},
												/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "exchange_forum",
					source_field: "exchange_forum_id",
					source_id: obj["exchange_forum_id"],
					user_id
				};
