				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 交流论坛 -->
							<div><span>交流论坛</span></div>
							<view_exchange_forum v-if="$check_action('/exchange_forum/view','get')"></view_exchange_forum>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_exchange_forum from "../../components/diy/view_exchange_forum.vue";
	export default {
		data() {
			return {
			};
