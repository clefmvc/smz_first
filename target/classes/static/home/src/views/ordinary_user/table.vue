				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_ordinary_user v-if="$check_action('/ordinary_user/table','get')"></table_ordinary_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_ordinary_user from "../../components/diy/table_ordinary_user.vue";
	export default {
		data() {
			return {
			};
